...
for line = 1:length(training_angle_indexes)
    ...
    [par, fval, flag] = fminunc(@(opt_pars)gplvm_max_log_like(sigma_f, ...
                                                              [l_disp l_mu], ...
                                                              sigma_n_y,...
                                                              [y_ref_taps; y_train{line}(MIN_I_TRAIN:MAX_I_TRAIN,:)] ,...
                                                              [[disp_ref_taps; x_real(MIN_I_TRAIN:MAX_I_TRAIN,line)+real_shift+opt_pars(1)] ...
                                                               [mu_ref_taps; ones(21,1)*mu_ref_taps]]),...
                                init_hyper_pars_3,...
                                optimoptions('fminunc','Display','off','MaxFunEvals',10000));
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    flag
