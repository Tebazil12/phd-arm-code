...
Expt.workFrame = [326-4 -272 68 180 0 180];%flower
...
fprintf(info_file, '-----------------------\r\n');
fprintf(info_file, 'Robot code online: no dissim,3refs,flower,3pts,limits added,step size = 5mm. Stopping removed, 3 rounds (ish). Removed refs from model.\r\n');
fclose(info_file);
