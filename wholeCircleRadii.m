...
switch ONLINE
    ...
    case true
        ...
        Expt.workFrame = [475 180 69 180 0 180];%[475 180 69 180 0 180]; % board 2 ABB1 % specify work frame wrt base frame (x,y,z,r,p,y) %find using abb jogger
...
for iSet = 1:Expt.nSets       
    ...
    % untwist sensor
    for index = [1 2]
        robot.move([0 0 0 0 0 -95*index]) % rotate back to start pose: (190/2)=95 (as rotation by >=180 is dangerous)
    end
end
