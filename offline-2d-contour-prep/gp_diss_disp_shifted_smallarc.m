...
load('/home/lizzie/git/masters-tactile/data/singleRadius2019-01-09_1442/c01_01.mat')
all_data{1}= fliplr(data);
load('/home/lizzie/git/masters-tactile/data/singleRadius2019-01-09_1442/c02_01.mat')
all_data{2}= fliplr(data);
load('/home/lizzie/git/masters-tactile/data/singleRadius2019-01-09_1442/c03_01.mat')
all_data{3}= fliplr(data);
load('/home/lizzie/git/masters-tactile/data/singleRadius2019-01-09_1442/c04_01.mat')
all_data{4}= fliplr(data);
load('/home/lizzie/git/masters-tactile/data/singleRadius2019-01-09_1442/c05_01.mat')
all_data{5}= fliplr(data);
load('/home/lizzie/git/masters-tactile/data/singleRadius2019-01-09_1442/c06_01.mat')
all_data{6}= fliplr(data);
load('/home/lizzie/git/masters-tactile/data/singleRadius2019-01-09_1442/c07_01.mat')
all_data{7}= fliplr(data);
load('/home/lizzie/git/masters-tactile/data/singleRadius2019-01-09_1442/c08_01.mat')
all_data{8}= fliplr(data);
load('/home/lizzie/git/masters-tactile/data/singleRadius2019-01-09_1442/c09_01.mat')
all_data{9}= fliplr(data);
load('/home/lizzie/git/masters-tactile/data/singleRadius2019-01-09_1442/c10_01.mat')
all_data{10}= fliplr(data);
load('/home/lizzie/git/masters-tactile/data/singleRadius2019-01-09_1442/c11_01.mat')
all_data{11}= fliplr(data);
load('/home/lizzie/git/masters-tactile/data/singleRadius2019-01-09_1442/c12_01.mat')
all_data{12}= fliplr(data);
load('/home/lizzie/git/masters-tactile/data/singleRadius2019-01-09_1442/c13_01.mat')
all_data{13}= fliplr(data);
load('/home/lizzie/git/masters-tactile/data/singleRadius2019-01-09_1442/c14_01.mat')
all_data{14}= fliplr(data);
load('/home/lizzie/git/masters-tactile/data/singleRadius2019-01-09_1442/c15_01.mat')
all_data{15}= fliplr(data);
load('/home/lizzie/git/masters-tactile/data/singleRadius2019-01-09_1442/c16_01.mat')
all_data{16}= fliplr(data);
load('/home/lizzie/git/masters-tactile/data/singleRadius2019-01-09_1442/c17_01.mat')
all_data{17}= fliplr(data);
load('/home/lizzie/git/masters-tactile/data/singleRadius2019-01-09_1442/c18_01.mat')
all_data{18}= fliplr(data);
load('/home/lizzie/git/masters-tactile/data/singleRadius2019-01-09_1442/c19_01.mat')
...
sigma_n_y = 1.94;
sigma_n_diss = 0.5;%1.94;

i_trainings = [10 15 19 5 1];
for num_training = 1:5
    
    [dissims{num_training}, y_train{num_training}, x_diffs{num_training}, y_diffs{num_training}] = process_taps(all_data{i_trainings(num_training)},...
                                                            ref_diffs_norm,...
...
% fmincon(fun,x0,A,b,Aeq,beq,lb,ub)
        ...
        [par, fval, flag] = fmincon(@(opt_pars)gplvm_max_log_like(sigma_f,...
                                                                  [l_disp l_mu],...
                                                                  sigma_n_y,...
...
function x_min  = radius_diss_shift(dissims, x_matrix, sigma_n, TRAIN_MIN_DISP)
    ...
    [par, fval, flag] = fminunc(@(mypar)gp_max_log_like(mypar(1), mypar(2), sigma_n,...
                                                        dissims' , x_matrix(:,1)),...
                                [10 0.5] ,optimoptions('fminunc','Display','off'));
...
%         plot(y(round(num_plot/2),1:127)+ref_tap(1 ,:  ,1),y(round(num_plot/2),128:end)+ref_tap(1 ,:  ,2),'o','Color',colour_graph)
        plot(y(round(num_plot/2),1:126)+ref_tap(1 ,:  ,1),y(round(num_plot/2),127:end)+ref_tap(1 ,:  ,2),'o','Color','b')
