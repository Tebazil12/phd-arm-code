...
%% %%%%%%%%%%%%% Training mu %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%      
init_hyper_pars_2 = [0 0];

[par, fval, flag] = fminunc(@(opt_pars)gplvm_max_log_like(sigma_f, ...
                                                          [l_disp l_mu], ...
                                                          sigma_n_y,...
                                                          y_gplvm_input ,[ [x_real(MIN_I_TRAIN:MAX_I_TRAIN,1);...
                                                                            x_real(MIN_I_TRAIN:MAX_I_TRAIN,2);...
                                                                            x_real(MIN_I_TRAIN:MAX_I_TRAIN,3);...
                                                                            x_real(MIN_I_TRAIN:MAX_I_TRAIN,4);...
                                                                            x_real(MIN_I_TRAIN:MAX_I_TRAIN,5)] ...
                                                                           [zeros(size_x2);...
                                                                            opt_pars(1)*ones(size_x2);...
                                                                            2*ones(size_x2);...
                                                                            opt_pars(2)*ones(size_x2);...
                                                                            -2*ones(size_x2)] ]),...
                            init_hyper_pars_2,...
...
% fmincon(fun,x0,A,b,Aeq,beq,lb,ub)
    ...
    [par, fval, flag] = fminunc(@(opt_pars)gplvm_max_log_like(sigma_f,...
                                                              [l_disp l_mu],...
                                                              sigma_n_y,...
                                                              [y_gplvm_input; y_test(MIN_I_TEST:MAX_I_TEST,:)],...
                                                              [x_gplvm_input; [MIN_I_TEST:MAX_I_TEST]' ones(size(MIN_I_TEST:MAX_I_TEST))'*opt_pars(1)]),...
                                init_latent_vars,...
                                optimoptions('fminunc','Display','off'));
